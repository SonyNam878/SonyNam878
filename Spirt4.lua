...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("chỉ hộ trợ Blox Fruits")
end
        ...
        if DevilFruitESP then
            if string.find(v.Name, "Fruit") then   
                if not v.Handle:FindFirstChild('NameEsp'..Number) then
                    ...
                    name.BackgroundTransparency = 1
                    name.TextStrokeTransparency = 0.5
                    name.TextColor3 = Color3.fromRGB(140, 195, 200)
            ...
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    if not v:FindFirstChild("MobEap") then
                        ...
                        TextLabel.BackgroundColor3 = Color3.fromRGB(140, 195, 200)
...
ToggleButton.Image = "rbxassetid://17416719866"
ToggleButton.ScaleType = Enum.ScaleType.Fit

-- Thay đổi kích thước của nút để tạo hình tròn
ToggleButton.SizeConstraint = Enum.SizeConstraint.RelativeYY

-- Thêm UICorner để biến nút thành hình tròn
...
local Window = OrionLib:MakeWindow({Name = "Galaxy Hub", HidePremium = false, IntroText = "Galaxy Hub", SaveConfig = false, ConfigFolder = "Galaxy Hub"})
----------Tab-----------------------
...
local Section = W:AddSection({
    ...
    local StastMelee = W:AddLabel("Galaxy X Min Gaming")
    local StastDefense = W:AddLabel("Youtube: Min Gaming")
    local StastSword = W:AddLabel("Youtube: EW-OS-RAD")
    local StastGun = W:AddLabel("Discord: https://discord.com/invite/JyWP7sh2wX")
	...
	while task.wait() do
		pcall(function()
			if game.Workspace.Map:FindFirstChild("KitsuneIsland") then
				mr:Set("Kitsune Island :  Có")
			else
				mr:Set("Kitsune Island :  Không")
			end
		end)
	end
end)
...
local Section = IQ:AddSection({
    Name = "Tự động Dual Cursed Katana"
})

IQ:AddToggle({
    Name = "Tự động Dual Cursed Katana",
    Default = false,
    Flag = "Tự động DualCursed Katana",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Tự động treo đảo bí ẩn (Dỏm)",
    Default = false,
    ...
    while wait(.10) do
        if LockLevel then
            if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
                game.Players.localPlayer:Kick("Ai Mượn Mày Bấm")
            end
        end
    end
end)
            ...
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.Farmfast and StardMag then
                        if (v.Name == "Royal Soldier" or v.Name == "Royal Squad" or v.Name == "Shanda") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                    ...
                    if _G.AutoVampire and Galaxy then
                        if (v.Name == "Vampire") and (v.HumanoidRootPart.Position - PosVui.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                ...
                while wait() do
                    if _G.RaidPirate then
                        pcall(function()
                            ...
                            if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if _G.RaidPirate and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                        if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                                            repeat wait()
                                                AutoHaki()
                                                EquipWeapon(_G.SelectWeapon)
                                                v.HumanoidRootPart.CanCollide = false
                                ...
                                if BypassTP then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameBoss.Position).Magnitude <= _G.BringMode then
                                BTP(CFrameBoss)
                                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameBoss.Position).Magnitude <= _G.BringMode then
                                topos(CFrameBoss)
                                end
                                end
                            end
...
spawn(function()
    ...
    if _G.AutoSharkman then
        if Mybeli <= 2500000 or MyFragment <= 5000 then
            ...
            OrionLib:MakeNotification({
                Name = "Galaxy Hub",
                Content = "Mày Đéo Đủ Tiền Và Điểm F",
                Image = "rbxassetid://17416719866",
                Time = 5
            })
            end
            ...
            pcall(function()
                if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true) == 1 then
                        ...
                        OrionLib:MakeNotification({
                            Name = "Galaxy Hub",
                            Content = "Mày Đéo Có SharkMan Karate",
                            Image = "rbxassetid://17416719866",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then
                        ...
                        gOrionLib:MakeNotification({
                            Name = "Galaxy Hub",
                            Content = "Mày Đéo Có Electric Claw",
                            Image = "rbxassetid://17416719866",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value >= 400 or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon").Level.Value >= 400 then
                            if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman",true), "Bring") then
                                OrionLib:MakeNotification({
                                    Name = "Galaxy Hub",
                                    Content = "Mày Đéo Đủ Nguyên Liệu",
                                    Image = "rbxassetid://17416719866",
                                    Time = 5
                                })
                        ...
                        OrionLib:MakeNotification({
                            Name = "Galaxy Hub",
                            Content = "Mày Đéo Có Dragon Talon",
                            Image = "rbxassetid://17416719866",
                            Time = 5
                        })
